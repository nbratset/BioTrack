...
run test_bad_alpha_file python src/run_pipeline.py -n 'John Doe' --alpha_file input_data/bad_file.csv
assert_exit_code 0
assert_in_stdout "Missing alpha diversity File"

run test_bad_beta_file python src/run_pipeline.py -n 'John Doe' --beta_file input_data/bad_file.csv
assert_exit_code 0
assert_in_stdout "Missing beta diversity File"

run test_bad_diff_file python src/run_pipeline.py -n 'John Doe' --diff_file input_data/bad_file.csv
assert_exit_code 0
